            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><img src="img\<?= $item["image"] ?> " width="241" height="135" /></td>
                        <td class="text-center"><?php echo $item["details"] ?> </td>
                        <td class="text-center"><a
                                href="update.php?code1=<?= $item["code"] ?> & name=<?= $item["name"] ?> & price=<?= $item["price"] ?> & image=<?= $item["image"] ?> & details=<?= $item["details"] ?>"
                                onclick="return confirm('Want to update ?');"><button type="button"
                                    class="btn btn-primary">Update</button>
                            </a> &nbsp; | &nbsp;
                            <a href="delete.php?code1=<?= $item["code"] ?>"
